...
#+begin_src emacs-lisp :tangle init.el :comments no
  (setq org-capture-templates
	'(("t" "New TODO" entry (file+headline "~/org/gtd/inbox.org" "Sort me!")
	   "**  TODO %?"
	   :empty-lines-after 1)

	  ("s" "New Scheduled item" entry (file+headline "~/org/gtd/inbox.org" "Sort me!")
	   "**  %?\n SCHEDULED: %^T"
	   :empty-lines-after 1)

	  ("d" "New Deadline item" entry (file+headline "~/org/gtd/inbox.org" "Sort me!")
	   "**  %?\n DEADLINE: %^T"
	   :empty-lines-after 1)))
#+end_src
