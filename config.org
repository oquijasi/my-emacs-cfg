...
;; Add Straight's Org path explicitly (ensure it takes precedence)
...
Este código se ejecuta *al abrir este fichero de configuración*, y permite que la configuración se auto-exporte a los ficheros que usa Emacs al guardarse SOLO SI SE ABRE EMACS DESDE ANDROID.
